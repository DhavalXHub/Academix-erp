# 🎓 Academix ERP - Comprehensive System Documentation
...
Create a `.env` file in the root `Academix/server` folder with the following:
```env
PORT=5000
NODE_ENV=development
MONGO_URI=mongodb://localhost:27017/academix_db
