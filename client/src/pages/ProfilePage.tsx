        ...
        const load = async () => {
            try {
                ...
                const initialSocials = data.user.socials || (data.profile as any)?.socials || [
                    { platform: 'GitHub', url: 'https://github.com/academix-user', icon: '💻' },
                    { platform: 'LinkedIn', url: 'https://linkedin.com/in/academix-user', icon: '🔗' },
                ];
            ...
            <div style={styles.headerContainer}>
                ...
                <div style={styles.headerContent}>
                    ...
                    <div style={styles.headerInfo}>
                        ...
                        <p style={styles.profileMeta}>📍 Academix ERP Ecosystem • Active Session</p>
                    </div>
