...
const styles: Record<string, React.CSSProperties> = {
    ...
    courseCard: { padding: '16px', border: '1px solid #e5e7eb', borderRadius: '8px', backgroundColor: '#f9fafb' },
    ...
    progressBar: { width: '100%', height: '8px', backgroundColor: '#e5e7eb', borderRadius: '4px', overflow: 'hidden', marginBottom: '4px' },
    table: { border: '1px solid #e5e7eb', borderRadius: '8px', overflow: 'hidden' },
    tableHeader: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', backgroundColor: '#f3f4f6', padding: '12px 16px', fontWeight: 700, fontSize: '12px', color: '#111827', borderBottom: '1px solid #e5e7eb' },
    tableRow: { display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', padding: '12px 16px', borderBottom: '1px solid #e5e7eb', fontSize: '13px', color: '#6b7280' },
};
