            ...
            <div className="lp-hero-inner">
                ...
                <div>
                    ...
                    <p className="lp-hero-sub">
                        Unify your entire educational ecosystem. From intelligent attendance tracking to real-time analytics, Academix empowers students, faculty, and administrators in one beautifully designed platform.
                    </p>
                ...
                <div className="lp-mockup">
                    <div className="lp-mockup-wrapper">
                        <div className="lp-mockup-chrome">
                            ...
                            <div className="lp-chrome-url">academix-app.com/admin/dashboard</div>
                        </div>
