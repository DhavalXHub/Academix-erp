...
const styles: Record<string, React.CSSProperties> = {
    ...
    card: { background: '#fff', padding: '24px', borderRadius: 12, border: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', gap: 16, boxShadow: '0 1px 3px rgba(0,0,0,0.05)' },
    iconBox: { width: 48, height: 48, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 },
    label: { margin: '0 0 4px', fontSize: 13, color: '#6b7280', fontWeight: 600, textTransform: 'uppercase' },
    value: { margin: 0, fontSize: 24, fontWeight: 700, color: '#111827' }
};
