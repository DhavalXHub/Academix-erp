...
const s: Record<string, React.CSSProperties> = {
    wrapper: {
        ...
        padding: '4rem 2rem', textAlign: 'center', background: '#f9fafb',
        borderRadius: 16, border: '1.5px dashed #d1d5db',
    },
    iconWrap: { fontSize: 48, marginBottom: 16, lineHeight: 1 },
    title: { margin: '0 0 8px', fontSize: 18, fontWeight: 700, color: '#111827' },
    message: { margin: 0, fontSize: 14, color: '#6b7280', fontWeight: 500, maxWidth: 360, lineHeight: 1.6 },
    btn: {
