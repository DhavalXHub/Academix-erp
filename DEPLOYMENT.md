# Academix ERP - Production Deployment Guide
...
1. **MongoDB Atlas Setup**
   ...
   - Copy the connection URI: `mongodb+srv://username:password@cluster.xxxxx.mongodb.net/academix?retryWrites=true&w=majority`
...
1. **New Web Service**
   ...
   - Select the Academix repository
   - Name: `academix-erp` (or your preference)
   - Environment: `Node`
...
- Original Academix documentation - Comprehensive feature guide
