...
const importData = async () => {
    try {
        ...
        const facultyUser1 = await User.create({ name: 'Dr. John Smith', email: 'john.smith@academix.edu', password: 'password123', role: 'faculty' });
        ...
        console.log('  Faculty:  john.smith@academix.edu      / password123');
        console.log('  Faculty:  sarah.johnson@academix.edu   / password123');
        console.log('  Faculty:  michael.chen@academix.edu    / password123');
        console.log('  Student:  student1@academix.edu        / password123');
        console.log('  Student:  student2@academix.edu        / password123');
        console.log('\n📊 Created:');
